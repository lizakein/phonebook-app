...
const { createAccessRequest, getAccessRequestsByUserId, updateAccessRequestStatus, checkAccessRequest, checkAccessRequestStatus, getAllAccessRequestsByStatusAndSort } = require('../controllers/accessController');
...
router.get('/access-requests', authenticateToken, getAllAccessRequestsByStatusAndSort);
